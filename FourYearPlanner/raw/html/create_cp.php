...
// courses for IST minor
	...
	$ist_result = mysqli_query($con, $ist_req);
	...
	$ist2_result = mysqli_query($con, $ist2_req);
		...
		//establish credit count variables and spans
			...
			//change "data-location" attribute accrding to where dropped, add to total if needed
				if (a == "box1"){
					...
					document.getElementById(data).setAttribute("data-location", "sourcebox10");
				}
				else if (a == "11"){
					document.getElementById(data).setAttribute("data-location", "sourcebox11");
				}
				else if (a == "summer"){
			...
			function save() {
				...
				//let thing = document.getElementById('selected');
...
?>					
				...
				<div style="display: table-cell;">
					<div id="sourcebox4" ondrop="drop(event,'4')" ondragover="allowDrop(event)" style="margin: 5px; width: 120px; border: 1px solid #7895A2;"><p style="text-align: center; background-color: #7895A2; color: white;"> one pair from Languages:</p>
<?php
...
?>	
					...
					<div id="sourcebox5" ondrop="drop(event,'5')" ondragover="allowDrop(event)" style="width: 120px; border: 1px solid #AFC1CC; margin: 5px;"><p style="text-align: center; background-color: #AFC1CC;"> one from Religion:</p>
<?php
...
?>
				...
				<div style="display: table-cell;">
					<div id="sourcebox6" ondrop="drop(event,'6')" ondragover="allowDrop(event)" style=" width: 120px; margin: 5px; border: 1px solid #D2CAA3;"><p style="text-align: center; background-color: #D2CAA3;"> one from Creative Exp:</p>
<?php
...
?>	
				...
				<div style="display: table-cell;">
					<div id="sourcebox7" ondrop="drop(event,'7')" ondragover="allowDrop(event)" style="width: 120px; margin: 5px; border: 1px solid #F4D27A;"><p style="text-align: center; background-color: #F4D27A;"> one from W. Heritage:</p>
<?php
...
?>	
				...
				<div style="display: table-cell;">
					<div id="sourcebox8" ondrop="drop(event,'8')" ondragover="allowDrop(event)" style="width: 120px; margin: 5px; border: 1px solid #ee9e53;"><p style="text-align: center; background-color: #ee9e53; color: white;"> one from Behavior &amp; Soc:</p>
<?php
...
?>
					...
					<div id="sourcebox9" ondrop="drop(event)" ondragover="allowDrop(event,'9')" style="width: 120px; border: 1px solid #eb803d; margin: 5px;"><p style="text-align: center; background-color: #eb803d; color: white;"> one from Nat. World:</p>
<?php
...
?>	
				...
				<div style="display: table-cell;">
					<div id="sourcebox8" ondrop="drop(event,'8')" ondragover="allowDrop(event)" style="width: 120px; margin: 5px; border: 1px solid #ee9e53;"><p style="text-align: center; background-color: #ee9e53; color: white;"> one from Behaivor &amp; Soc:</p>
<?php
		while ($row = $cla5_result->fetch_assoc()){
			echo '<div class="dragitem" draggable="true" ondragstart="drag(event)" style="background-color: #ee9e53; color: white;" data-location="sourcebox8" id="' .$row['CourseID']. '" data-value="' .$row['Credits']. '">' .$row['CourseID']; 
			 if( is_null($row['Prerequisites']) != 1){ 
...
////////////////////////////////////////////////////////////////////////
		...
		$cscs1_result = mysqli_query($con, $cscs1_req);
		$cscs2_result = mysqli_query($con, $cscs2_req);
		$cscs3_result = mysqli_query($con, $cscs3_req);
		if ($minor == "STA"){
			while ($row = $sta_result->fetch_assoc()){	
				echo '<div class="dragitem" draggable="true" ondragstart="drag(event)" style="background-color: black; color: white;" data-location="sourcebox1"  id="' .$row['CourseID']. '" data-value="' .$row['Credits']. '">' .$row['CourseID']; 
				 if( is_null($row['Prerequisites']) != 1){ 
		...
		if ($minor =="IST"){
			while ($row = $ist_result->fetch_assoc()){	
				echo '<div class="dragitem" draggable="true" ondragstart="drag(event)" style="background-color: black; color: white;" data-location="sourcebox1"  id="' .$row['CourseID']. '" data-value="' .$row['Credits']. '">' .$row['CourseID']; 
				 if( is_null($row['Prerequisites']) != 1){ 
					 echo '<span class="hide">'.$row['Title'].' ('.$row['Credits'].')('.$row['Availability'].')<br><span style="background-color: red;">PR: '.$row['Prerequisites'].'</span>';
				 } 
		...
		echo '<div class="dragitem" draggable="true" ondragstart="drag(event)" style="background-color: black; color: white;" data-location="sourcebox1" id="CSCodd1" data-value="3">Lab Science<span class="hide"> Additional Lab Science Course <br> consult CS faculty </span></div>';
		echo '<div class="dragitem" draggable="true" ondragstart="drag(event)" style="background-color: black; color: white;" data-location="sourcebox1" id="DATapplication" data-value="3">Lab or Math<span class="hide"> Additional Lab or Math Course <br> consult CS faculty</span></div>';
		while ($row = $cla0_result->fetch_assoc()){
			echo '<div class="dragitem" draggable="true" ondragstart="drag(event)" style="background-color: black; color: white;" data-location="sourcebox1"  id="' .$row['CourseID']. '" data-value="' .$row['Credits']. '">' .$row['CourseID']; 
			 if( is_null($row['Prerequisites']) != 1){ 
				 echo '<span class="hide">'.$row['Title'].' ('.$row['Credits'].')('.$row['Availability'].')<br><span style="background-color: red;">PR: '.$row['Prerequisites'].'</span>';
...
?>
					...
					<div id="sourcebox2" ondrop="drop(event,'2')" ondragover="allowDrop(event)" style="width: 120px; margin: 5px; border: 1px solid black; background-color: black;"><p style="text-align: center; color: white;">12 hours from:</p>
<?php
		while ($row = $csc1_result->fetch_assoc()){
			echo '<div class="dragitem" draggable="true" ondragstart="drag(event)" style="outline: 1px solid black; background-color: white;" data-location="sourcebox2" id="' .$row['CourseID']. '" data-value="' .$row['Credits']. '">' .$row['CourseID']; 
			 if( is_null($row['Prerequisites']) != 1){ 
				 echo '<span class="hide">'.$row['Title'].' ('.$row['Credits'].')('.$row['Availability'].')<br><span style="background-color: red;">PR: '.$row['Prerequisites'].'</span>';
			 } 
			 else{ 
...
?>	
					...
					<div id="sourcebox3" ondrop="drop(event,'3')" ondragover="allowDrop(event)" style="width: 120px; margin: 5px; border: 1px solid #151D21;"><p style="text-align: center; color: white; background-color: #151D21;"> one from:</p>
<?php
		while ($row = $cscs2_result->fetch_assoc()){
			echo '<div class="dragitem" draggable="true" ondragstart="drag(event)" style="background-color: #151D21; color: white;"  data-location="sourcebox3" id="' .$row['CourseID']. '" data-value="' .$row['Credits']. '">' .$row['CourseID']; 
			 if( is_null($row['Prerequisites']) != 1){ 
				 echo '<span class="hide">'.$row['Title'].' ('.$row['Credits'].')('.$row['Availability'].')<br><span style="background-color: red;">PR: '.$row['Prerequisites'].'</span>';
			 } 
			 else{ 
...
?>	
					...
					<div id="sourcebox4" ondrop="drop(event,'4')" ondragover="allowDrop(event)" style="width: 120px; margin: 5px; border: 1px solid #293941;"><p style="text-align: center; background-color: #293941; color: white;"> one pair from:</p>
<?php
		while ($row = $cscs3_result->fetch_assoc()){
			echo '<div class="dragitem" draggable="true" ondragstart="drag(event)" style="background-color: #293941; color: white;"  data-location="sourcebox4" id="' .$row['CourseID']. '" data-value="' .$row['Credits']. '">' .$row['CourseID']; 
			 if( is_null($row['Prerequisites']) != 1){ 
				 echo '<span class="hide">'.$row['Title'].' ('.$row['Credits'].')('.$row['Availability'].')<br><span style="background-color: red;">PR: '.$row['Prerequisites'].'</span>';
			 } 
			 else{ 
...
<?php 
	if ($minor == "STA"){
?>
					<div id="sourcebox5" ondrop="drop(event,'5')" ondragover="allowDrop(event)" style="width: 120px; margin: 5px; border: 1px solid #517281;"><p style="text-align: center; background-color: #517281; color: white;"> one and PR from:</p>
<?php
		while ($row = $sta1_result->fetch_assoc()){
			echo '<div class="dragitem" draggable="true" ondragstart="drag(event)" style="background-color: #517281; color: white;"  data-location="sourcebox5" id="' .$row['CourseID']. '" data-value="' .$row['Credits']. '">' .$row['CourseID']; 
			 if( is_null($row['Prerequisites']) != 1){ 
				 echo '<span class="hide">'.$row['Title'].' ('.$row['Credits'].')('.$row['Availability'].')<br><span style="background-color: red;">PR: '.$row['Prerequisites'].'</span>';
			 } 
			 else{ 
	...
	if ($minor == "CYS"){
?>
					<div id="sourcebox5" ondrop="drop(event,'5')" ondragover="allowDrop(event)" style="width: 120px; margin: 5px; border: 1px solid #517281;"><p style="text-align: center; background-color: #517281; color: white;"> 3 hours from:</p>
<?php
		while ($row = $cys1_result->fetch_assoc()){
			echo '<div class="dragitem" draggable="true" ondragstart="drag(event)" style="background-color: #517281; color: white;"  data-location="sourcebox5" id="' .$row['CourseID']. '" data-value="' .$row['Credits']. '">' .$row['CourseID']; 
			 if( is_null($row['Prerequisites']) != 1){ 
	...
	if ($minor == "IST"){
?>
					<div id="sourcebox5" ondrop="drop(event,'5')" ondragover="allowDrop(event)" style="width: 120px; margin: 5px; border: 1px solid #517281;"><p style="text-align: center; background-color: #517281; color: white;"> 9 hours (6 level 310+) from:</p>
<?php
		while ($row = $ist2_result->fetch_assoc()){
			echo '<div class="dragitem" draggable="true" ondragstart="drag(event)" style="background-color: #517281; color: white;"  data-location="sourcebox5" id="' .$row['CourseID']. '" data-value="' .$row['Credits']. '">' .$row['CourseID']; 
			 if( is_null($row['Prerequisites']) != 1){ 
				 echo '<span class="hide">'.$row['Title'].' ('.$row['Credits'].')('.$row['Availability'].')<br><span style="background-color: red;">PR: '.$row['Prerequisites'].'</span>';
			 } 
...
?>					
				...
				<div style="display: table-cell;">	
				<div id="sourcebox6" ondrop="drop(event,'6')" ondragover="allowDrop(event)" style="margin: 5px; width: 120px; border: 1px solid #7895A2;"><p style="text-align: center; background-color: #7895A2; color: white;"> one pair from Languages:</p>
<?php
		while ($row = $cla1_result->fetch_assoc()){
			echo '<div class="dragitem" draggable="true" ondragstart="drag(event)"  style="background-color: #7895A2; color: white;" data-location="sourcebox6"  id="' .$row['CourseID']. '" data-value="' .$row['Credits']. '">' .$row['CourseID']; 
			 if( is_null($row['Prerequisites']) != 1){ 
				 echo '<span class="hide">'.$row['Title'].' ('.$row['Credits'].')('.$row['Availability'].')<br><span style="background-color: red;">PR: '.$row['Prerequisites'].'</span>';
			 } 
			 else{ 
...
?>	
					...
					<div id="sourcebox7" ondrop="drop(event,'7')" ondragover="allowDrop(event)" style="width: 120px; border: 1px solid #AFC1CC; margin: 5px;"><p style="text-align: center; background-color: #AFC1CC;"> one from Religion:</p>
<?php
		while ($row = $cla2_result->fetch_assoc()){
			echo '<div class="dragitem" draggable="true" ondragstart="drag(event)" style="background-color: #AFC1CC;"  data-location="sourcebox7" id="' .$row['CourseID']. '" data-value="' .$row['Credits']. '">' .$row['CourseID']; 
			 if( is_null($row['Prerequisites']) != 1){ 
				 echo '<span class="hide">'.$row['Title'].' ('.$row['Credits'].')('.$row['Availability'].')<br><span style="background-color: red;">PR: '.$row['Prerequisites'].'</span>';
			 } 
			 else{ 
...
?>
				...
				<div style="display: table-cell;">
					<div id="sourcebox8" ondrop="drop(event,'8')" ondragover="allowDrop(event)" style=" width: 120px; margin: 5px; border: 1px solid #D2CAA3;"><p style="text-align: center; background-color: #D2CAA3;"> one from Creative Exp:</p>
<?php
		while ($row = $cla3_result->fetch_assoc()){
			echo '<div class="dragitem" draggable="true" ondragstart="drag(event)"  style="background-color: #D2CAA3;" data-location="sourcebox8" id="' .$row['CourseID']. '" data-value="' .$row['Credits']. '">' .$row['CourseID']; 
			 if( is_null($row['Prerequisites']) != 1){ 
				 echo '<span class="hide">'.$row['Title'].' ('.$row['Credits'].')('.$row['Availability'].')<br><span style="background-color: red;">PR: '.$row['Prerequisites'].'</span>';
			 } 
			 else{ 
...
?>	
				...
				<div style="display: table-cell;">
					<div id="sourcebox9" ondrop="drop(event,'9')" ondragover="allowDrop(event)" style="width: 120px; margin: 5px; border: 1px solid #F4D27A;"><p style="text-align: center; background-color: #F4D27A;"> one from W. Heritage:</p>
<?php
		while ($row = $cla4_result->fetch_assoc()){
			echo '<div class="dragitem" draggable="true" ondragstart="drag(event)" style="background-color: #F4D27A;" data-location="sourcebox9" id="' .$row['CourseID']. '" data-value="' .$row['Credits']. '">' .$row['CourseID']; 
			 if( is_null($row['Prerequisites']) != 1){ 
				 echo '<span class="hide">'.$row['Title'].' ('.$row['Credits'].')('.$row['Availability'].')<br><span style="background-color: red;">PR: '.$row['Prerequisites'].'</span>';
			 } 
			 else{ 
...
?>	
				...
				<div style="display: table-cell;">
					<div id="sourcebox10" ondrop="drop(event,'10')" ondragover="allowDrop(event)" style="width: 120px; margin: 5px; border: 1px solid #ee9e53;"><p style="text-align: center; background-color: #ee9e53; color: white;"> one from Behavior &amp; Soc:</p>
<?php
		while ($row = $cla5_result->fetch_assoc()){
			echo '<div class="dragitem" draggable="true" ondragstart="drag(event)" style="background-color: #ee9e53; color: white;" data-location="sourcebox10" id="' .$row['CourseID']. '" data-value="' .$row['Credits']. '">' .$row['CourseID']; 
			 if( is_null($row['Prerequisites']) != 1){ 
				 echo '<span class="hide">'.$row['Title'].' ('.$row['Credits'].')('.$row['Availability'].')<br><span style="background-color: red;">PR: '.$row['Prerequisites'].'</span>';
			 } 
			 else{ 
...
?>
					...
					<div id="sourcebox11" ondrop="drop(event)" ondragover="allowDrop(event,'11')" style="width: 120px; border: 1px solid #eb803d; margin: 5px;"><p style="text-align: center; background-color: #eb803d; color: white;"> one from Nat. World:</p>
<?php
		while ($row = $cla6_result->fetch_assoc()){
			echo '<div class="dragitem" draggable="true" ondragstart="drag(event)" style="background-color: #eb803d; color: white;" data-location="sourcebox11" id="' .$row['CourseID']. '" data-value="' .$row['Credits']. '">' .$row['CourseID']; 
			 if( is_null($row['Prerequisites']) != 1){ 
				 echo '<span class="hide">'.$row['Title'].' ('.$row['Credits'].')('.$row['Availability'].')<br><span style="background-color: red;">PR: '.$row['Prerequisites'].'</span>';
	 } 
			 else{ 
...
// /////////////////////////////////////////////////////////////////////
		...
		$csca1_result = mysqli_query($con, $csca1_req);
		$csca2_result = mysqli_query($con, $csca2_req);
		$csca3_result = mysqli_query($con, $csca3_req);
		if ($minor == "STA"){
			while ($row = $sta_result->fetch_assoc()){	
				echo '<div class="dragitem" draggable="true" ondragstart="drag(event)" style="background-color: black; color: white;" data-location="sourcebox1"  id="' .$row['CourseID']. '" data-value="' .$row['Credits']. '">' .$row['CourseID']; 
				 if( is_null($row['Prerequisites']) != 1){ 
...
?>
					...
					<div id="sourcebox2" ondrop="drop(event,'2')" ondragover="allowDrop(event)" style="width: 120px; margin: 5px; border: 1px solid black; background-color: black;"><p style="text-align: center; color: white;"> one from:</p>
<?php
		while ($row = $csca1_result->fetch_assoc()){
			echo '<div class="dragitem" draggable="true" ondragstart="drag(event)" style=" background-color: white;"  data-location="sourcebox2" id="' .$row['CourseID']. '" data-value="' .$row['Credits']. '">' .$row['CourseID']; 
			 if( is_null($row['Prerequisites']) != 1){ 
				 echo '<span class="hide">'.$row['Title'].' ('.$row['Credits'].')('.$row['Availability'].')<br><span style="background-color: red;">PR: '.$row['Prerequisites'].'</span>';
			 } 
			 else{ 
...
?>	
					...
					<div id="sourcebox3" ondrop="drop(event,'3')" ondragover="allowDrop(event)" style="width: 120px; margin: 5px; border: 1px solid #151D21;"><p style="text-align: center; background-color: #151D21; color: white;"> one from:</p>
<?php
		while ($row = $csca2_result->fetch_assoc()){
			echo '<div class="dragitem" draggable="true" ondragstart="drag(event)" style="background-color: #151D21; color: white;"  data-location="sourcebox3" id="' .$row['CourseID']. '" data-value="' .$row['Credits']. '">' .$row['CourseID']; 
			 if( is_null($row['Prerequisites']) != 1){ 
				 echo '<span class="hide">'.$row['Title'].' ('.$row['Credits'].')('.$row['Availability'].')<br><span style="background-color: red;">PR: '.$row['Prerequisites'].'</span>';
			 } 
...
?>	
					...
					<div id="sourcebox4" ondrop="drop(event,'4')" ondragover="allowDrop(event)" style="width: 120px; margin: 5px; border: 1px solid #293941;"><p style="text-align: center; background-color: #293941; color: white;"> 12 hours from:</p>
<?php
		while ($row = $csca3_result->fetch_assoc()){
			echo '<div class="dragitem" draggable="true" ondragstart="drag(event)" style="background-color: #293941; color: white;"  data-location="sourcebox4" id="' .$row['CourseID']. '" data-value="' .$row['Credits']. '">' .$row['CourseID']; 
			 if( is_null($row['Prerequisites']) != 1){ 
				 echo '<span class="hide">'.$row['Title'].' ('.$row['Credits'].')('.$row['Availability'].')<br><span style="background-color: red;">PR: '.$row['Prerequisites'].'</span>';
			 } 
...
<!-- table for with each semester's drop box -->
			<div style="display: table-cell;" id="selected">
...
<!-- drop boxes for summer and transfer courses -->
				...
				<button onclick="save()"> <h4> Download </h4> </button>
			</div>
